...
from cirtorch.networks.ciconv2d import CIConv2d
...
class ResNet(nn.Module):
    def __init__(self, block, layers, invariant=None, num_classes=1000, zero_init_residual=False,
                 ...
                 k=3, scale=0.0, return_features=False):
...
if __name__ == '__main__':
    print('Printing ResNet model definition.')
    m = resnet101(pretrained=True, invariant='W').cuda()
    print(m)
